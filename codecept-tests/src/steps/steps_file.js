...
module.exports = function() {
  return actor({
    ...
    createKRR(){
      ...
      this.fillField('#idporten.input.CONTACTINFO_EMAIL', '24079497513-Digdir@digdir.no');
      this.fillField('#idporten.inputrepeat.CONTACTINFO_EMAIL', '24079497513-Digdir@digdir.no');
