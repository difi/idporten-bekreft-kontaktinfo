...
class BandIdHelper extends Helper {
  ...
  async loginWithBankId() {
    ...
    await innerFrame.type('#' + fnrInputFieldId, process.env.IBK_USERNAME);
    ...
    await innerFrame.type('#' + otpInputFieldId, process.env.IBK_OTP);
    ...
    await innerFrame.type('#' + pwdInputFieldId, process.env.IBK_PASSWORD);
    await page.keyboard.press('Enter');
