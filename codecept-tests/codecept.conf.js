require('dotenv').config({path: (process.env.CODECEPT_ARGS && '.env.atest') || '.env'});
...
exports.config = {
    ...
    helpers: {
        Puppeteer: {
            ...
            windowSize: "1200x900",
            show: (process.env.IBK_SHOW_GUI === "true"),
            chrome: {
        ...
        // REST: {
        //   endpoint: process.env.IBK_HOST + '/api',
        // },
        AssertWrapper: {
        ...
        reporterOptions: {
            'mocha-junit-reporter': {
                ...
                options: {
                    ...
                    testsuitesTitle: 'ID-porten bekreft kontaktinfo tests',
                    attachments: true,
                    jenkinsMode: true
                },
