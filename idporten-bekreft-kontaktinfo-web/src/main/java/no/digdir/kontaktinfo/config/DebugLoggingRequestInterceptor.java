...
@Component
public class DebugLoggingRequestInterceptor implements ClientHttpRequestInterceptor {

    private final static Logger log = LoggerFactory.getLogger(DebugLoggingRequestInterceptor.class);
