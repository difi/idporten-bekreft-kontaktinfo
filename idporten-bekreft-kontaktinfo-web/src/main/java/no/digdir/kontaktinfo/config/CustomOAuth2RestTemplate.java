...
public class CustomOAuth2RestTemplate extends RestTemplate {
    public CustomOAuth2RestTemplate(@Autowired(required = false) DebugLoggingRequestInterceptor loggingInterceptor,
